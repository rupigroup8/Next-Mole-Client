...
interface ForceGraphMethods {
  // Link styling
  emitParticle(link: LinkObject): ForceGraphVRInstance;

  // Force engine (d3-force) configuration
  d3Force(forceName: 'link' | 'charge' | 'center' | string): ForceFn | undefined;
  d3Force(forceName: 'link' | 'charge' | 'center' | string, forceFn: ForceFn): ForceGraphVRInstance;
...
type LinkPositionUpdateFn$1 = (obj: Object3D, coords: { start: Coords$1, end: Coords$1 }, link: LinkObject$1) => null | boolean;

interface ForceGraphProps$1 extends ConfigOptions$1 {
  // Data input
  ...
  nodeDesc?: NodeAccessor$1<string>;
  ...
  linkDesc?: LinkAccessor$1<string>;
  ...
  // Interaction
  onNodeCenterHover?: (node: NodeObject$1 | null, previousNode: NodeObject$1 | null) => void;
  onLinkCenterHover?: (link: LinkObject$1 | null, previousLink: LinkObject$1 | null) => void;
}

interface ForceGraphMethods$1 {
  // Link styling
  emitParticle(link: LinkObject$1): ForceGraphARInstance;

  // Force engine (d3-force) configuration
  d3Force(forceName: 'link' | 'charge' | 'center' | string): ForceFn$1 | undefined;
  d3Force(forceName: 'link' | 'charge' | 'center' | string, forceFn: ForceFn$1): ForceGraphARInstance;
...
type FCwithRef$1<P = {}, R = {}> = FunctionComponent<P & { ref?: MutableRefObject<R | undefined> }>;
...
type LinkPositionUpdateFn$2 = (obj: Object3D, coords: { start: Coords$2, end: Coords$2 }, link: LinkObject$2) => null | boolean;

interface ForceGraphProps$2 extends ConfigOptions$2 {
  // Data input
  ...
  nodeLabel?: NodeAccessor$2<string>;
  ...
  // Link styling
  linkLabel?: LinkAccessor$2<string>;
  ...
  // Interaction
  onNodeClick?: (node: NodeObject$2, event: MouseEvent) => void;
  onNodeRightClick?: (node: NodeObject$2, event: MouseEvent) => void;
  onNodeHover?: (node: NodeObject$2 | null, previousNode: NodeObject$2 | null) => void;
  onNodeDrag?: (node: NodeObject$2, translate: { x: number, y: number }) => void;
  onNodeDragEnd?: (node: NodeObject$2, translate: { x: number, y: number }) => void;
  onLinkClick?: (link: LinkObject$2, event: MouseEvent) => void;
  onLinkRightClick?: (link: LinkObject$2, event: MouseEvent) => void;
...
interface ForceGraphMethods$2 {
  // Link styling
  emitParticle(link: LinkObject$2): ForceGraph3DInstance;

  // Force engine (d3-force) configuration
  d3Force(forceName: 'link' | 'charge' | 'center' | string): ForceFn$2 | undefined;
  d3Force(forceName: 'link' | 'charge' | 'center' | string, forceFn: ForceFn$2): ForceGraph3DInstance;
  d3ReheatSimulation(): ForceGraph3DInstance;

  // Render control
  pauseAnimation(): ForceGraph3DInstance;
  resumeAnimation(): ForceGraph3DInstance;
  cameraPosition(position: Partial<Coords$2>, lookAt?: Coords$2, transitionMs?: number): ForceGraph3DInstance;
  zoomToFit(durationMs?: number, padding?: number, nodeFilter?: (node: NodeObject$2) => boolean): ForceGraph3DInstance;
  ...
  graph2ScreenCoords(x: number, y: number, z: number): Coords$2;
}

type FCwithRef$2<P = {}, R = {}> = FunctionComponent<P & { ref?: MutableRefObject<R | undefined> }>;
...
type DagMode$3 = 'td' | 'bu' | 'lr' | 'rl' | 'radialout' | 'radialin';
...
interface ForceGraphProps$3 {
  ...
  nodeCanvasObject?: CanvasCustomRenderFn<NodeObject$3>;
  nodeCanvasObjectMode?: string | ((obj: NodeObject$3) => CanvasCustomRenderMode);
  ...
  linkLineDash?: LinkAccessor$3<number[] | null>;
  linkWidth?: LinkAccessor$3<number>;
  linkCurvature?: LinkAccessor$3<number>;
  linkCanvasObject?: CanvasCustomRenderFn<LinkObject$3>;
  linkCanvasObjectMode?: string | ((obj: LinkObject$3) => CanvasCustomRenderMode);
  ...
  // Interaction
  onNodeClick?: (node: NodeObject$3, event: MouseEvent) => void;
  onNodeRightClick?: (node: NodeObject$3, event: MouseEvent) => void;
  onNodeHover?: (node: NodeObject$3 | null, previousNode: NodeObject$3 | null) => void;
  onNodeDrag?: (node: NodeObject$3, translate: { x: number, y: number }) => void;
  onNodeDragEnd?: (node: NodeObject$3, translate: { x: number, y: number }) => void;
  onLinkClick?: (link: LinkObject$3, event: MouseEvent) => void;
  onLinkRightClick?: (link: LinkObject$3, event: MouseEvent) => void;
...
interface ForceGraphMethods$3 {
  // Link styling
  emitParticle(link: LinkObject$3): ForceGraphInstance;

  // Force engine (d3-force) configuration
  d3Force(forceName: 'link' | 'charge' | 'center' | string): ForceFn$3 | undefined;
  d3Force(forceName: 'link' | 'charge' | 'center' | string, forceFn: ForceFn$3): ForceGraphInstance;
  ...
  zoomToFit(durationMs?: number, padding?: number, nodeFilter?: (node: NodeObject$3) => boolean): ForceGraphInstance;

  // Utility
  getGraphBbox(nodeFilter?: (node: NodeObject$3) => boolean): { x: [number, number], y: [number, number] };
  screen2GraphCoords(x: number, y: number): { x: number, y: number };
  graph2ScreenCoords(x: number, y: number): { x: number, y: number };
}

type FCwithRef$3<P = {}, R = {}> = FunctionComponent<P & { ref?: MutableRefObject<R | undefined> }>;

declare const ForceGraph$3: FCwithRef$3<ForceGraphProps$3, ForceGraphMethods$3>;

export { ForceGraph$3 as ForceGraph2D, ForceGraph$2 as ForceGraph3D, ForceGraph$1 as ForceGraphAR, ForceGraph as ForceGraphVR };
